...
int main (){
    ...
    for(int i = 0; i < rows; i++){
        if( i == 0){
            std::cout << "Cars manufactured by Ford are" << std::setw(5) << " = ";
            cargroup(cars, i, columns);
        }
        else if ( i == 1){
            std::cout << "Cars Manufactured by Nissan are = ";
            cargroup(cars, i, columns);
        }
        else if ( i == 2){
            std::cout << "Cars Manufactured by Chevy  are = ";
            cargroup(cars, i, columns);
        }
        std::cout << '\n';
    }
